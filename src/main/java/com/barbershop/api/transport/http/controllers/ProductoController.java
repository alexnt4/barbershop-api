...
import com.barbershop.api.service.interactors.GenerarReporteInventarioInteractor;
...
public class ProductoController {
        ...
        /**
         * Interactor para generar reporte de inventario.
         */
        private final GenerarReporteInventarioInteractor generarReporteInventarioInteractor;
         ...
         * @param generarReporteInventarioInteractorParam      Interactor de reporte.
         */
        public ProductoController(
                        ...
                        final GenerarReporteInventarioInteractor generarReporteInventarioInteractorParam) {
                ...
                this.generarReporteInventarioInteractor = generarReporteInventarioInteractorParam;
        }
         ...
         *
         * @return ResponseEntity con el reporte de inventario.
         */
        @GetMapping("/reporte")
        @PreAuthorize("hasAnyRole('ADMINISTRADOR', 'BARBERO')")
        @Operation(summary = "Generar reporte de inventario", description = "Genera un reporte completo con el stock actual de cada producto, "
                        + "su precio, proveedor y estadísticas generales del inventario "
                        + "(total de productos, unidades, valor total y productos con stock bajo)")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Reporte generado exitosamente")
        })
        public ResponseEntity<ReporteInventarioDTO> generarReporteInventario() {
                ReporteInventarioDTO reporte = generarReporteInventarioInteractor.execute();
